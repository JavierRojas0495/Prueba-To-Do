...
el nombre de la base de datos es bd_pruebas_pana
...
El desarrollo tiene JavaScript,PHP,Jquery,SweetAlert,DataTable,Validaciones para campos vacios y numericos
 ...
 Tener en cuenta que para ingresar a la web deben ir a localhost/ nombre de la carpeta (Prueba-To-Do)  /web
...
-> Tarea (Registro, Validaciones, CRUD, Cambio de estado )
================================================================================================================================

Correo para poder iniciar la session

Correo: usuarioprueba@pana.com
password: 12345
